                ...
                <div class="ai-upload-optons">
                    <ul>
                        <li class="ai-upload-add-project-list">
                            ...
                            <a class="download" href="javascript:void(0)" data-download-url="{{ asset($value->generated_image) }}" title="Download" download
                        ...
                        @if($value->hd_image == 0)
                            <li class="ai-upload-add-project-list on-gen-disable">
                                ...
                                <a class="full_hd_quality" href="javascript:void(0)" data-input-img="{{ $value->original_image }}" data-img="{{ $value->generated_image }}"
                                    data-item="hd_quality" title="Full HD Quality" data-sec="{{ $value->design_type }}">
