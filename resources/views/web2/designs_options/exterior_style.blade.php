    ...
    <div class="modal-dialog gs-modal-container">
        <div class="modal-content gs-modal-content">
            ...
            <div class="gs-select-room-style-row" id="allDesignStyles1">
                <div class="gs-select-room-style-single" data-design-style="No Style - Image Improvment Only"
                    onclick="selectDesignStyle('No Style - Image Improvment Only',1)">
                ...
                <div class="gs-select-room-style-single" data-design-style="Dutch Colonial Revival"
                    onclick="selectDesignStyle('Dutch Colonial Revival',1)">
                    <img src="{{ asset('web2/images/select-room-type4.png') }}">
                    <span>Dutch Colonial Revival</span>
                </div>
